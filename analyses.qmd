...
2. A tidy summary of the model's coefficients, including 90% confidence intervals for model estimates.

3. The model's R-squared, residual standard error (sigma), and the number of observations to which the model was fit.
...
You will need to provide some evidence on how well the "pairing" worked in this setting, by interpreting the Pearson correlation between the CHR 2019 and CHR 2024 values.
