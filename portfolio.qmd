...
All portfolio elements (R data set, Quarto and HTML report, video and self-evaluation) are due in late October at the time and date indicated on the [Course Calendar](https://thomaselove.github.io/431-2024/calendar.html). 
...
- Everyone (including both members of each team) should fill out [the self-evaluation form](https://bit.ly/431-projectA-self-evaluation-2024) **after** all other materials are posted to Canvas.
...
5. Either the option `theme_bw()` or `theme_light()` is used as part of your package loading, to ensure that your ggplot-based graphs are easy to view.
...
Project A is graded on a scale from 0 to 100, theoretically, although I expect the highest grade to be around 95. Dr. Love works with the TAs to provide feedback and grade the projects, but the final Project A grade is determined solely by him.

- A successful **Plan** is a mandatory part of Project A, and is worth 20 points as part of the Project A grade. 
- The **Portfolio Report** is worth 45 points. It is unlikely that anyone will score above 43 points, which is the planned score for a completely accurate and polished report. Most scores will likely fall between 32 and 42 points on this element.
...
- The **Video** is worth 25 points. It is unlikely that anyone will score above 24 points, which is the planned score for a very strong presentation, which is clear to see and hear and which is very effective. Most scores will likely fall between 18 and 23 points on this element.
...
Project grading is set up to generate a median score near 85.
