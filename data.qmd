...
Use the `filter()` function from the `dplyr` package in the `tidyverse` to include only the counties ranked by CHR. (A county_clustered value of 1 means that the county was ranked.)
...
After making your selection, and filtering the data, you should have a tibble called `chr_2024` which contains all of the 300-800 counties in your six states, and 90 columns. 
